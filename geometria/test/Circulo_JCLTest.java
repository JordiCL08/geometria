...
public class Circulo_JCLTest {
	private double re;
	 private double AreaR;
	 private double PerimetroR;

	 public Circulo_JCLTest(double radio,double resultadoPerimetro, double resultadoArea) {
	  re=radio;
	  AreaR = resultadoArea;
	...
	public void testArea() {
		Circulo_JCL circulo = new Circulo_JCL(re,"test");
